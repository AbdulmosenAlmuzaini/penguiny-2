...
import 'math8_model.dart';
export 'math8_model.dart';

class Math8Widget extends StatefulWidget {
  const Math8Widget({super.key});

  static String routeName = 'math8';
  static String routePath = '/math8';

  @override
  State<Math8Widget> createState() => _Math8WidgetState();
}

class _Math8WidgetState extends State<Math8Widget> {
  late Math8Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Math8Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qmath8Record>>(
                stream: queryQmath8Record(
                  queryBuilder: (qmath8Record) =>
                      qmath8Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qmath8Record> containerQmath8RecordList = snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQmath8RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQmath8RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            GameoverMathWidget(
                                                                          videoURL:
                                                                              'https://youtu.be/vyy4d9NJE4Q?si=V19HOF8DyaeScay8',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
