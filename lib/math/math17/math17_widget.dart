...
import 'math17_model.dart';
export 'math17_model.dart';

class Math17Widget extends StatefulWidget {
  const Math17Widget({super.key});

  static String routeName = 'math17';
  static String routePath = '/math17';

  @override
  State<Math17Widget> createState() => _Math17WidgetState();
}

class _Math17WidgetState extends State<Math17Widget> {
  late Math17Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Math17Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qmath17Record>>(
                stream: queryQmath17Record(
                  queryBuilder: (qmath17Record) =>
                      qmath17Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qmath17Record> containerQmath17RecordList =
                      snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQmath17RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQmath17RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            GameoverMathWidget(
                                                                          videoURL:
                                                                              'https://youtu.be/knf8sM0q3W4?si=vwzKuBEDmTZ7JwC8',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
