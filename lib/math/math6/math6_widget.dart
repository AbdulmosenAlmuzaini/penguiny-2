...
import 'math6_model.dart';
export 'math6_model.dart';

class Math6Widget extends StatefulWidget {
  const Math6Widget({super.key});

  static String routeName = 'math6';
  static String routePath = '/math6';

  @override
  State<Math6Widget> createState() => _Math6WidgetState();
}

class _Math6WidgetState extends State<Math6Widget> {
  late Math6Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Math6Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qmath6Record>>(
                stream: queryQmath6Record(
                  queryBuilder: (qmath6Record) =>
                      qmath6Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qmath6Record> containerQmath6RecordList = snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQmath6RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQmath6RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            GameoverMathWidget(
                                                                          videoURL:
                                                                              'https://youtu.be/FgmGNDZhy6M?si=21sp4pUy2NnPpbq6',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
