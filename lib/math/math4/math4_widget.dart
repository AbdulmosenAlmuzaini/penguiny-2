...
import 'math4_model.dart';
export 'math4_model.dart';

class Math4Widget extends StatefulWidget {
  const Math4Widget({super.key});

  static String routeName = 'math4';
  static String routePath = '/math4';

  @override
  State<Math4Widget> createState() => _Math4WidgetState();
}

class _Math4WidgetState extends State<Math4Widget> {
  late Math4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Math4Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qmath4Record>>(
                stream: queryQmath4Record(
                  queryBuilder: (qmath4Record) =>
                      qmath4Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qmath4Record> containerQmath4RecordList = snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQmath4RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQmath4RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            GameoverMathWidget(
                                                                          videoURL:
                                                                              'https://youtu.be/sPyRNbJ5mWQ?si=mu75Ve4ySKLN_sng',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
