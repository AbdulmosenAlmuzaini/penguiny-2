...
import 'math11_model.dart';
export 'math11_model.dart';

class Math11Widget extends StatefulWidget {
  const Math11Widget({super.key});

  static String routeName = 'math11';
  static String routePath = '/math11';

  @override
  State<Math11Widget> createState() => _Math11WidgetState();
}

class _Math11WidgetState extends State<Math11Widget> {
  late Math11Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Math11Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qmath11Record>>(
                stream: queryQmath11Record(
                  queryBuilder: (qmath11Record) =>
                      qmath11Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qmath11Record> containerQmath11RecordList =
                      snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQmath11RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                          animateFromLastPercent: true,
                          progressColor: Color(0xFFAD1811),
                          backgroundColor: Color(0xFFFFC9C9),
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQmath11RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            GameoverMathWidget(
                                                                          videoURL:
                                                                              'https://youtu.be/yU6Hj6bFOVc?si=xY2NQhPg0zXdgEHY',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      padding: MediaQuery
                                                                          .viewInsetsOf(
                                                                              context),
                                                                      child:
                                                                          CongratulationsMathWidget(
                                                                        addPoint:
                                                                            () async {
                                                                          if (FFAppState().mathpoints ==
                                                                              10) {
                                                                            FFAppState().mathpoints =
                                                                                FFAppState().mathpoints + 1;
                                                                            safeSetState(() {});
                                                                          }
                                                                        },
                                                                      ),
