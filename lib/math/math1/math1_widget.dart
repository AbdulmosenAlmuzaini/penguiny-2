...
import 'math1_model.dart';
export 'math1_model.dart';

class Math1Widget extends StatefulWidget {
  const Math1Widget({super.key});

  static String routeName = 'math1';
  static String routePath = '/math1';

  @override
  State<Math1Widget> createState() => _Math1WidgetState();
}

class _Math1WidgetState extends State<Math1Widget> {
  late Math1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Math1Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qmath1Record>>(
                stream: queryQmath1Record(
                  queryBuilder: (qmath1Record) =>
                      qmath1Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qmath1Record> containerQmath1RecordList = snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQmath1RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQmath1RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            GameoverMathWidget(
                                                                          videoURL:
                                                                              'https://youtu.be/doQRTg6hzOY?si=C92Sw12ZasFyJrlb',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
