...
import 'math9_model.dart';
export 'math9_model.dart';

class Math9Widget extends StatefulWidget {
  const Math9Widget({super.key});

  static String routeName = 'math9';
  static String routePath = '/math9';

  @override
  State<Math9Widget> createState() => _Math9WidgetState();
}

class _Math9WidgetState extends State<Math9Widget> {
  late Math9Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Math9Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qmath9Record>>(
                stream: queryQmath9Record(
                  queryBuilder: (qmath9Record) =>
                      qmath9Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qmath9Record> containerQmath9RecordList = snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQmath9RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQmath9RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            GameoverMathWidget(
                                                                          videoURL:
                                                                              'https://youtu.be/zNym7dYiQ-Q?si=hzok8X9S-hInMvmt',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
