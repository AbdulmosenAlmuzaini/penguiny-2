...
import 'math10_model.dart';
export 'math10_model.dart';

class Math10Widget extends StatefulWidget {
  const Math10Widget({super.key});

  static String routeName = 'math10';
  static String routePath = '/math10';

  @override
  State<Math10Widget> createState() => _Math10WidgetState();
}

class _Math10WidgetState extends State<Math10Widget> {
  late Math10Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Math10Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qmath10Record>>(
                stream: queryQmath10Record(
                  queryBuilder: (qmath10Record) =>
                      qmath10Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qmath10Record> containerQmath10RecordList =
                      snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQmath10RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQmath10RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            GameoverMathWidget(
                                                                          videoURL:
                                                                              'https://youtu.be/SNunnPJ7EhI?si=co0RvaLPGMZ6RC3i',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
