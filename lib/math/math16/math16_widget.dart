...
import 'math16_model.dart';
export 'math16_model.dart';

class Math16Widget extends StatefulWidget {
  const Math16Widget({super.key});

  static String routeName = 'math16';
  static String routePath = '/math16';

  @override
  State<Math16Widget> createState() => _Math16WidgetState();
}

class _Math16WidgetState extends State<Math16Widget> {
  late Math16Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Math16Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qmath16Record>>(
                stream: queryQmath16Record(
                  queryBuilder: (qmath16Record) =>
                      qmath16Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qmath16Record> containerQmath16RecordList =
                      snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQmath16RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQmath16RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            GameoverMathWidget(
                                                                          videoURL:
                                                                              'https://youtu.be/KzYFy77Dg3U?si=ZZt1dl0tPFGkqYur',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
