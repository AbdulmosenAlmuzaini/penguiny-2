...
import 'math13_model.dart';
export 'math13_model.dart';

class Math13Widget extends StatefulWidget {
  const Math13Widget({super.key});

  static String routeName = 'math13';
  static String routePath = '/math13';

  @override
  State<Math13Widget> createState() => _Math13WidgetState();
}

class _Math13WidgetState extends State<Math13Widget> {
  late Math13Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Math13Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qmath13Record>>(
                stream: queryQmath13Record(
                  queryBuilder: (qmath13Record) =>
                      qmath13Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qmath13Record> containerQmath13RecordList =
                      snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQmath13RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQmath13RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            GameoverMathWidget(
                                                                          videoURL:
                                                                              'https://youtu.be/Aiv5YjBI3ag?si=ZCIKGaO1Hnvr7Le9',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
