...
import 'math15_model.dart';
export 'math15_model.dart';

class Math15Widget extends StatefulWidget {
  const Math15Widget({super.key});

  static String routeName = 'math15';
  static String routePath = '/math15';

  @override
  State<Math15Widget> createState() => _Math15WidgetState();
}

class _Math15WidgetState extends State<Math15Widget> {
  late Math15Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Math15Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qmath15Record>>(
                stream: queryQmath15Record(
                  queryBuilder: (qmath15Record) =>
                      qmath15Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qmath15Record> containerQmath15RecordList =
                      snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQmath15RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQmath15RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            GameoverMathWidget(
                                                                          videoURL:
                                                                              'https://youtu.be/gs7WxIrMkTA?si=_M032AIC33AqrPtx',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
