...
import 'math14_model.dart';
export 'math14_model.dart';

class Math14Widget extends StatefulWidget {
  const Math14Widget({super.key});

  static String routeName = 'math14';
  static String routePath = '/math14';

  @override
  State<Math14Widget> createState() => _Math14WidgetState();
}

class _Math14WidgetState extends State<Math14Widget> {
  late Math14Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Math14Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qmath14Record>>(
                stream: queryQmath14Record(
                  queryBuilder: (qmath14Record) =>
                      qmath14Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qmath14Record> containerQmath14RecordList =
                      snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQmath14RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQmath14RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            GameoverMathWidget(
                                                                          videoURL:
                                                                              'https://youtu.be/uuXNTAmptO0?si=22QmFw8qzeES0wjC',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
