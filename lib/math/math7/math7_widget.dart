...
import 'math7_model.dart';
export 'math7_model.dart';

class Math7Widget extends StatefulWidget {
  const Math7Widget({super.key});

  static String routeName = 'math7';
  static String routePath = '/math7';

  @override
  State<Math7Widget> createState() => _Math7WidgetState();
}

class _Math7WidgetState extends State<Math7Widget> {
  late Math7Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Math7Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qmath7Record>>(
                stream: queryQmath7Record(
                  queryBuilder: (qmath7Record) =>
                      qmath7Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qmath7Record> containerQmath7RecordList = snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQmath7RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQmath7RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            GameoverMathWidget(
                                                                          videoURL:
                                                                              'https://youtu.be/0JAF3NoSH-8?si=DiK2YKGp2r-KhLu6',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
