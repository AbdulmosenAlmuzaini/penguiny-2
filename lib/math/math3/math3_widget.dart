...
import 'math3_model.dart';
export 'math3_model.dart';

class Math3Widget extends StatefulWidget {
  const Math3Widget({super.key});

  static String routeName = 'math3';
  static String routePath = '/math3';

  @override
  State<Math3Widget> createState() => _Math3WidgetState();
}

class _Math3WidgetState extends State<Math3Widget> {
  late Math3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Math3Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qmath3Record>>(
                stream: queryQmath3Record(
                  queryBuilder: (qmath3Record) =>
                      qmath3Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qmath3Record> containerQmath3RecordList = snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQmath3RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQmath3RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            GameoverMathWidget(
                                                                          videoURL:
                                                                              'https://youtu.be/4UnOD1aWCRo?si=plrCz9a6iVf_rrbQ',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
