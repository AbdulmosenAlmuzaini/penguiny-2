...
import 'math5_model.dart';
export 'math5_model.dart';

class Math5Widget extends StatefulWidget {
  const Math5Widget({super.key});

  static String routeName = 'math5';
  static String routePath = '/math5';

  @override
  State<Math5Widget> createState() => _Math5WidgetState();
}

class _Math5WidgetState extends State<Math5Widget> {
  late Math5Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Math5Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qmath5Record>>(
                stream: queryQmath5Record(
                  queryBuilder: (qmath5Record) =>
                      qmath5Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qmath5Record> containerQmath5RecordList = snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQmath5RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQmath5RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            GameoverMathWidget(
                                                                          videoURL:
                                                                              'https://youtu.be/smt2lyFhWMQ?si=pSmv9RGuw3Sfrr1X',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
