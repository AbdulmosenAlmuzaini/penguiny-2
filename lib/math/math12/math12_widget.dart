...
import 'math12_model.dart';
export 'math12_model.dart';

class Math12Widget extends StatefulWidget {
  const Math12Widget({super.key});

  static String routeName = 'math12';
  static String routePath = '/math12';

  @override
  State<Math12Widget> createState() => _Math12WidgetState();
}

class _Math12WidgetState extends State<Math12Widget> {
  late Math12Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Math12Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qmath12Record>>(
                stream: queryQmath12Record(
                  queryBuilder: (qmath12Record) =>
                      qmath12Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qmath12Record> containerQmath12RecordList =
                      snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQmath12RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQmath12RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            GameoverMathWidget(
                                                                          videoURL:
                                                                              'https://youtu.be/LwxGaqLu5oU?si=ZF35yFShsxdJp_jF',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
