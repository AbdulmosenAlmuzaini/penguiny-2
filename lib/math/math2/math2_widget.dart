...
import 'math2_model.dart';
export 'math2_model.dart';

class Math2Widget extends StatefulWidget {
  const Math2Widget({super.key});

  static String routeName = 'math2';
  static String routePath = '/math2';

  @override
  State<Math2Widget> createState() => _Math2WidgetState();
}

class _Math2WidgetState extends State<Math2Widget> {
  late Math2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Math2Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qmath2Record>>(
                stream: queryQmath2Record(
                  queryBuilder: (qmath2Record) =>
                      qmath2Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qmath2Record> containerQmath2RecordList = snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQmath2RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQmath2RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            GameoverMathWidget(
                                                                          videoURL:
                                                                              'https://youtu.be/4S9EgoPHRx4?si=dpo2z1d5IqP0GI9t',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
