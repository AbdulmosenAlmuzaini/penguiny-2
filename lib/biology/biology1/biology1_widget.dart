...
import 'biology1_model.dart';
export 'biology1_model.dart';

class Biology1Widget extends StatefulWidget {
  const Biology1Widget({super.key});

  static String routeName = 'biology1';
  static String routePath = '/biology1';

  @override
  State<Biology1Widget> createState() => _Biology1WidgetState();
}

class _Biology1WidgetState extends State<Biology1Widget> {
  late Biology1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Biology1Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<QBiology1Record>>(
                stream: queryQBiology1Record(
                  queryBuilder: (qBiology1Record) =>
                      qBiology1Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<QBiology1Record> containerQBiology1RecordList =
                      snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQBiology1RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQBiology1RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          videoURL:
                                                                              'https://youtu.be/SE6NpcsEzrc?si=AVAPYA1Q5qBoqr-S',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
