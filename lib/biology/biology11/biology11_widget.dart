...
import 'biology11_model.dart';
export 'biology11_model.dart';

class Biology11Widget extends StatefulWidget {
  const Biology11Widget({super.key});

  static String routeName = 'biology11';
  static String routePath = '/biology11';

  @override
  State<Biology11Widget> createState() => _Biology11WidgetState();
}

class _Biology11WidgetState extends State<Biology11Widget> {
  late Biology11Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Biology11Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qbiology11Record>>(
                stream: queryQbiology11Record(
                  queryBuilder: (qbiology11Record) =>
                      qbiology11Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qbiology11Record> containerQbiology11RecordList =
                      snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQbiology11RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                          animateFromLastPercent: true,
                          progressColor: Color(0xFF4A7732),
                          backgroundColor: Color(0xFFC4F9C7),
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQbiology11RecordList.toList();
                                                                  ...
                                                                  builder:
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            GameoverBiologyWidget(
                                                                          videoURL:
                                                                              'https://youtu.be/CG_IBOqz6ik?si=uzZunjZA-DJFQ6eY',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      padding: MediaQuery
                                                                          .viewInsetsOf(
                                                                              context),
                                                                      child:
                                                                          CongratulationsBiologyWidget(
                                                                        addPoint:
                                                                            () async {
                                                                          if (FFAppState().biologypoints ==
                                                                              10) {
                                                                            FFAppState().biologypoints =
                                                                                FFAppState().biologypoints + 1;
                                                                            safeSetState(() {});
                                                                          }
                                                                        },
                                                                      ),
