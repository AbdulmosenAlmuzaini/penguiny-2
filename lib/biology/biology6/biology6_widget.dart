...
import 'biology6_model.dart';
export 'biology6_model.dart';

class Biology6Widget extends StatefulWidget {
  const Biology6Widget({super.key});

  static String routeName = 'biology6';
  static String routePath = '/biology6';

  @override
  State<Biology6Widget> createState() => _Biology6WidgetState();
}

class _Biology6WidgetState extends State<Biology6Widget> {
  late Biology6Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Biology6Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qbiology6Record>>(
                stream: queryQbiology6Record(
                  queryBuilder: (qbiology6Record) =>
                      qbiology6Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qbiology6Record> containerQbiology6RecordList =
                      snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQbiology6RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQbiology6RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          videoURL:
                                                                              'https://youtu.be/cWI80lX00p8?si=IptxQoNi-zkUzWug',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
