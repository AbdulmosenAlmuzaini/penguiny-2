...
import 'biology8_model.dart';
export 'biology8_model.dart';

class Biology8Widget extends StatefulWidget {
  const Biology8Widget({super.key});

  static String routeName = 'biology8';
  static String routePath = '/biology8';

  @override
  State<Biology8Widget> createState() => _Biology8WidgetState();
}

class _Biology8WidgetState extends State<Biology8Widget> {
  late Biology8Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Biology8Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qbiology8Record>>(
                stream: queryQbiology8Record(
                  queryBuilder: (qbiology8Record) =>
                      qbiology8Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qbiology8Record> containerQbiology8RecordList =
                      snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQbiology8RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQbiology8RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          videoURL:
                                                                              'https://youtu.be/pS55cWf1M4A?si=L5Ha0SeUIN0GHzT4',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
