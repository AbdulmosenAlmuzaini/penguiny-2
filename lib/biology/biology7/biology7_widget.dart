...
import 'biology7_model.dart';
export 'biology7_model.dart';

class Biology7Widget extends StatefulWidget {
  const Biology7Widget({super.key});

  static String routeName = 'biology7';
  static String routePath = '/biology7';

  @override
  State<Biology7Widget> createState() => _Biology7WidgetState();
}

class _Biology7WidgetState extends State<Biology7Widget> {
  late Biology7Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Biology7Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qbiology7Record>>(
                stream: queryQbiology7Record(
                  queryBuilder: (qbiology7Record) =>
                      qbiology7Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qbiology7Record> containerQbiology7RecordList =
                      snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQbiology7RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQbiology7RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          videoURL:
                                                                              'https://youtu.be/cZwt8-Vqdh8?si=-Clv7enSVghMeJC5',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
