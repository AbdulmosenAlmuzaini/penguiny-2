...
import 'biology9_model.dart';
export 'biology9_model.dart';

class Biology9Widget extends StatefulWidget {
  const Biology9Widget({super.key});

  static String routeName = 'biology9';
  static String routePath = '/biology9';

  @override
  State<Biology9Widget> createState() => _Biology9WidgetState();
}

class _Biology9WidgetState extends State<Biology9Widget> {
  late Biology9Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Biology9Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qbiology9Record>>(
                stream: queryQbiology9Record(
                  queryBuilder: (qbiology9Record) =>
                      qbiology9Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qbiology9Record> containerQbiology9RecordList =
                      snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQbiology9RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQbiology9RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          videoURL:
                                                                              'https://youtu.be/CBnM3whj5D4?si=Zzd8JheNm0oNgzbA',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
