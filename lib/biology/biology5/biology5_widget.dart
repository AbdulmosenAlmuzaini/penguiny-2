...
import 'biology5_model.dart';
export 'biology5_model.dart';

class Biology5Widget extends StatefulWidget {
  const Biology5Widget({super.key});

  static String routeName = 'biology5';
  static String routePath = '/biology5';

  @override
  State<Biology5Widget> createState() => _Biology5WidgetState();
}

class _Biology5WidgetState extends State<Biology5Widget> {
  late Biology5Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Biology5Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qbiology5Record>>(
                stream: queryQbiology5Record(
                  queryBuilder: (qbiology5Record) =>
                      qbiology5Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qbiology5Record> containerQbiology5RecordList =
                      snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQbiology5RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQbiology5RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          videoURL:
                                                                              'https://youtu.be/Da-uHNF80mg?si=tinSmlZN565AUUoN',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
