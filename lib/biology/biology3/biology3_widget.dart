...
import 'biology3_model.dart';
export 'biology3_model.dart';

class Biology3Widget extends StatefulWidget {
  const Biology3Widget({super.key});

  static String routeName = 'biology3';
  static String routePath = '/biology3';

  @override
  State<Biology3Widget> createState() => _Biology3WidgetState();
}

class _Biology3WidgetState extends State<Biology3Widget> {
  late Biology3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Biology3Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qbiology3Record>>(
                stream: queryQbiology3Record(
                  queryBuilder: (qbiology3Record) =>
                      qbiology3Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qbiology3Record> containerQbiology3RecordList =
                      snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQbiology3RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQbiology3RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          videoURL:
                                                                              'https://youtu.be/j7h8C4-SDoc?si=k4hvOkcCAx1tqeUQ',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
