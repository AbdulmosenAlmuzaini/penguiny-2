...
import 'biology10_model.dart';
export 'biology10_model.dart';

class Biology10Widget extends StatefulWidget {
  const Biology10Widget({super.key});

  static String routeName = 'biology10';
  static String routePath = '/biology10';

  @override
  State<Biology10Widget> createState() => _Biology10WidgetState();
}

class _Biology10WidgetState extends State<Biology10Widget> {
  late Biology10Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Biology10Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qbiology10Record>>(
                stream: queryQbiology10Record(
                  queryBuilder: (qbiology10Record) =>
                      qbiology10Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qbiology10Record> containerQbiology10RecordList =
                      snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQbiology10RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQbiology10RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          videoURL:
                                                                              'https://youtu.be/ldVKY3p5iqc?si=x3ioVmhpjDluu17C',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
