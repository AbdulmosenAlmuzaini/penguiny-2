...
import 'biology2_model.dart';
export 'biology2_model.dart';

class Biology2Widget extends StatefulWidget {
  const Biology2Widget({super.key});

  static String routeName = 'biology2';
  static String routePath = '/biology2';

  @override
  State<Biology2Widget> createState() => _Biology2WidgetState();
}

class _Biology2WidgetState extends State<Biology2Widget> {
  late Biology2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Biology2Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qbiology2Record>>(
                stream: queryQbiology2Record(
                  queryBuilder: (qbiology2Record) =>
                      qbiology2Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qbiology2Record> containerQbiology2RecordList =
                      snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQbiology2RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQbiology2RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          videoURL:
                                                                              'https://youtu.be/aZ4WOqZQCIk?si=m66-xealvihf3BKj',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
