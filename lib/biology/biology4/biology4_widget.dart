...
import 'biology4_model.dart';
export 'biology4_model.dart';

class Biology4Widget extends StatefulWidget {
  const Biology4Widget({super.key});

  static String routeName = 'biology4';
  static String routePath = '/biology4';

  @override
  State<Biology4Widget> createState() => _Biology4WidgetState();
}

class _Biology4WidgetState extends State<Biology4Widget> {
  late Biology4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Biology4Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qbiology4Record>>(
                stream: queryQbiology4Record(
                  queryBuilder: (qbiology4Record) =>
                      qbiology4Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qbiology4Record> containerQbiology4RecordList =
                      snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQbiology4RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQbiology4RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          videoURL:
                                                                              'https://youtu.be/ickrMKPSR9I?si=mYoesoXQ7hw5BNnG',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
