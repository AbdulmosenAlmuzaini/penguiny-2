...
import 'chemistry7_model.dart';
export 'chemistry7_model.dart';

class Chemistry7Widget extends StatefulWidget {
  const Chemistry7Widget({super.key});

  static String routeName = 'chemistry7';
  static String routePath = '/chemistry7';

  @override
  State<Chemistry7Widget> createState() => _Chemistry7WidgetState();
}

class _Chemistry7WidgetState extends State<Chemistry7Widget> {
  late Chemistry7Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Chemistry7Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qchemistry7Record>>(
                stream: queryQchemistry7Record(
                  queryBuilder: (qchemistry7Record) =>
                      qchemistry7Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qchemistry7Record> containerQchemistry7RecordList =
                      snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQchemistry7RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQchemistry7RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          videoURL:
                                                                              'https://youtu.be/GCaxrRqhyqc?si=SIGkgyFXn7jH5adQ',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
