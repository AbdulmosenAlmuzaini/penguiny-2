...
import 'chemistry1_model.dart';
export 'chemistry1_model.dart';

class Chemistry1Widget extends StatefulWidget {
  const Chemistry1Widget({super.key});

  static String routeName = 'chemistry1';
  static String routePath = '/chemistry1';

  @override
  State<Chemistry1Widget> createState() => _Chemistry1WidgetState();
}

class _Chemistry1WidgetState extends State<Chemistry1Widget> {
  late Chemistry1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Chemistry1Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qchemistry1Record>>(
                stream: queryQchemistry1Record(
                  queryBuilder: (qchemistry1Record) =>
                      qchemistry1Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qchemistry1Record> containerQchemistry1RecordList =
                      snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQchemistry1RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQchemistry1RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          videoURL:
                                                                              'https://youtu.be/tOMLy8jO0HM?si=deK4er-qOdYKcNFA',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
