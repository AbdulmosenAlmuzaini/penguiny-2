...
import 'chemistry10_model.dart';
export 'chemistry10_model.dart';

class Chemistry10Widget extends StatefulWidget {
  const Chemistry10Widget({super.key});

  static String routeName = 'chemistry10';
  static String routePath = '/chemistry10';

  @override
  State<Chemistry10Widget> createState() => _Chemistry10WidgetState();
}

class _Chemistry10WidgetState extends State<Chemistry10Widget> {
  late Chemistry10Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Chemistry10Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qchemistry10Record>>(
                stream: queryQchemistry10Record(
                  queryBuilder: (qchemistry10Record) =>
                      qchemistry10Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qchemistry10Record> containerQchemistry10RecordList =
                      snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQchemistry10RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQchemistry10RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          videoURL:
                                                                              'https://youtu.be/XXT1uhwX0wY?si=4x-f9KOmQkxugHvI',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
