...
import 'chemistry6_model.dart';
export 'chemistry6_model.dart';

class Chemistry6Widget extends StatefulWidget {
  const Chemistry6Widget({super.key});

  static String routeName = 'chemistry6';
  static String routePath = '/chemistry6';

  @override
  State<Chemistry6Widget> createState() => _Chemistry6WidgetState();
}

class _Chemistry6WidgetState extends State<Chemistry6Widget> {
  late Chemistry6Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Chemistry6Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qchemistry6Record>>(
                stream: queryQchemistry6Record(
                  queryBuilder: (qchemistry6Record) =>
                      qchemistry6Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qchemistry6Record> containerQchemistry6RecordList =
                      snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQchemistry6RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQchemistry6RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          videoURL:
                                                                              'https://youtu.be/zayzOCUAOxs?si=gO_WHk4BA7pms8Nf',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
