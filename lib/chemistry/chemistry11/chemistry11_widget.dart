...
import 'chemistry11_model.dart';
export 'chemistry11_model.dart';

class Chemistry11Widget extends StatefulWidget {
  const Chemistry11Widget({super.key});

  static String routeName = 'chemistry11';
  static String routePath = '/chemistry11';

  @override
  State<Chemistry11Widget> createState() => _Chemistry11WidgetState();
}

class _Chemistry11WidgetState extends State<Chemistry11Widget> {
  late Chemistry11Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Chemistry11Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qchemistry11Record>>(
                stream: queryQchemistry11Record(
                  queryBuilder: (qchemistry11Record) =>
                      qchemistry11Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qchemistry11Record> containerQchemistry11RecordList =
                      snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQchemistry11RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQchemistry11RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          videoURL:
                                                                              'https://youtu.be/CrBBTXcdXLU?si=BmjHWmdC4T8WVsAH',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
