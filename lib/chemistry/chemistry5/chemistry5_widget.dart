...
import 'chemistry5_model.dart';
export 'chemistry5_model.dart';

class Chemistry5Widget extends StatefulWidget {
  const Chemistry5Widget({super.key});

  static String routeName = 'chemistry5';
  static String routePath = '/chemistry5';

  @override
  State<Chemistry5Widget> createState() => _Chemistry5WidgetState();
}

class _Chemistry5WidgetState extends State<Chemistry5Widget> {
  late Chemistry5Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Chemistry5Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qchemistry5Record>>(
                stream: queryQchemistry5Record(
                  queryBuilder: (qchemistry5Record) =>
                      qchemistry5Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qchemistry5Record> containerQchemistry5RecordList =
                      snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQchemistry5RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQchemistry5RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          videoURL:
                                                                              'https://youtu.be/b6FuVu_7z1g?si=r0bhKxWXloAN_9bI',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
