...
import 'chemistry2_model.dart';
export 'chemistry2_model.dart';

class Chemistry2Widget extends StatefulWidget {
  const Chemistry2Widget({super.key});

  static String routeName = 'chemistry2';
  static String routePath = '/chemistry2';

  @override
  State<Chemistry2Widget> createState() => _Chemistry2WidgetState();
}

class _Chemistry2WidgetState extends State<Chemistry2Widget> {
  late Chemistry2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Chemistry2Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qchemisrty2Record>>(
                stream: queryQchemisrty2Record(
                  queryBuilder: (qchemisrty2Record) =>
                      qchemisrty2Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qchemisrty2Record> containerQchemisrty2RecordList =
                      snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQchemisrty2RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQchemisrty2RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          videoURL:
                                                                              'https://youtu.be/hXoyLyVkY2A?si=38GuOXkKVYo-i94n',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
