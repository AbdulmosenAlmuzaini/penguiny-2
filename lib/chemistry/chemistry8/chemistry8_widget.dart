...
import 'chemistry8_model.dart';
export 'chemistry8_model.dart';

class Chemistry8Widget extends StatefulWidget {
  const Chemistry8Widget({super.key});

  static String routeName = 'chemistry8';
  static String routePath = '/chemistry8';

  @override
  State<Chemistry8Widget> createState() => _Chemistry8WidgetState();
}

class _Chemistry8WidgetState extends State<Chemistry8Widget> {
  late Chemistry8Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Chemistry8Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qchemistry8Record>>(
                stream: queryQchemistry8Record(
                  queryBuilder: (qchemistry8Record) =>
                      qchemistry8Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qchemistry8Record> containerQchemistry8RecordList =
                      snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQchemistry8RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQchemistry8RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          videoURL:
                                                                              'https://youtu.be/kQjtm52fEOQ?si=MWooy19JzPa5h3vn',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
