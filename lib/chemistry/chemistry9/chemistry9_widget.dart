...
import 'chemistry9_model.dart';
export 'chemistry9_model.dart';

class Chemistry9Widget extends StatefulWidget {
  const Chemistry9Widget({super.key});

  static String routeName = 'chemistry9';
  static String routePath = '/chemistry9';

  @override
  State<Chemistry9Widget> createState() => _Chemistry9WidgetState();
}

class _Chemistry9WidgetState extends State<Chemistry9Widget> {
  late Chemistry9Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Chemistry9Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qchemistry9Record>>(
                stream: queryQchemistry9Record(
                  queryBuilder: (qchemistry9Record) =>
                      qchemistry9Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qchemistry9Record> containerQchemistry9RecordList =
                      snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQchemistry9RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQchemistry9RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          videoURL:
                                                                              'https://youtu.be/ZhUBpwiAWxs?si=-bo7V0DpmZeJEmsN',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
