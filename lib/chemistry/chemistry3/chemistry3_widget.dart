...
import 'chemistry3_model.dart';
export 'chemistry3_model.dart';

class Chemistry3Widget extends StatefulWidget {
  const Chemistry3Widget({super.key});

  static String routeName = 'chemistry3';
  static String routePath = '/chemistry3';

  @override
  State<Chemistry3Widget> createState() => _Chemistry3WidgetState();
}

class _Chemistry3WidgetState extends State<Chemistry3Widget> {
  late Chemistry3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Chemistry3Model());
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              StreamBuilder<List<Qchemistry3Record>>(
                stream: queryQchemistry3Record(
                  queryBuilder: (qchemistry3Record) =>
                      qchemistry3Record.orderBy('Q_number'),
                  limit: 10,
                ),
                builder: (context, snapshot) {
                  ...
                  List<Qchemistry3Record> containerQchemistry3RecordList =
                      snapshot.data!;
                      ...
                      children: [
                        LinearPercentIndicator(
                          percent: (_model.score!) /
                              containerQchemistry3RecordList.length,
                          width: 390.0,
                          lineHeight: 15.0,
                          animation: true,
                        ...
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final databaseitems =
                                  containerQchemistry3RecordList.toList();
                                                                    ...
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          videoURL:
                                                                              'https://youtu.be/YJMpSWUS0jw?si=I_tUGYl8mtoe69iU',
                                                                        ),
                                                                      ),
                                                                    );
                                                                  },
