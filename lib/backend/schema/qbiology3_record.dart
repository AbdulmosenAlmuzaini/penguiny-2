...
class Qbiology3Record extends FirestoreRecord {
  Qbiology3Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qbiology3');

  static Stream<Qbiology3Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qbiology3Record.fromSnapshot(s));

  static Future<Qbiology3Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qbiology3Record.fromSnapshot(s));

  static Qbiology3Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qbiology3Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qbiology3Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qbiology3Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qbiology3Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qbiology3Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQbiology3RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qbiology3RecordDocumentEquality implements Equality<Qbiology3Record> {
  const Qbiology3RecordDocumentEquality();

  @override
  bool equals(Qbiology3Record? e1, Qbiology3Record? e2) {
  ...
  @override
  int hash(Qbiology3Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qbiology3Record;
}
