...
class Qphysics2Record extends FirestoreRecord {
  Qphysics2Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qphysics2');

  static Stream<Qphysics2Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qphysics2Record.fromSnapshot(s));

  static Future<Qphysics2Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qphysics2Record.fromSnapshot(s));

  static Qphysics2Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qphysics2Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qphysics2Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qphysics2Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qphysics2Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qphysics2Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQphysics2RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qphysics2RecordDocumentEquality implements Equality<Qphysics2Record> {
  const Qphysics2RecordDocumentEquality();

  @override
  bool equals(Qphysics2Record? e1, Qphysics2Record? e2) {
  ...
  @override
  int hash(Qphysics2Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qphysics2Record;
}
