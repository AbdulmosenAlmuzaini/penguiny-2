...
class Qchemistry5Record extends FirestoreRecord {
  Qchemistry5Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qchemistry5');

  static Stream<Qchemistry5Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qchemistry5Record.fromSnapshot(s));

  static Future<Qchemistry5Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qchemistry5Record.fromSnapshot(s));

  static Qchemistry5Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qchemistry5Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qchemistry5Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qchemistry5Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qchemistry5Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qchemistry5Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQchemistry5RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qchemistry5RecordDocumentEquality implements Equality<Qchemistry5Record> {
  const Qchemistry5RecordDocumentEquality();

  @override
  bool equals(Qchemistry5Record? e1, Qchemistry5Record? e2) {
  ...
  @override
  int hash(Qchemistry5Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qchemistry5Record;
}
