...
class Qphysics9Record extends FirestoreRecord {
  Qphysics9Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qphysics9');

  static Stream<Qphysics9Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qphysics9Record.fromSnapshot(s));

  static Future<Qphysics9Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qphysics9Record.fromSnapshot(s));

  static Qphysics9Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qphysics9Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qphysics9Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qphysics9Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qphysics9Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qphysics9Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQphysics9RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qphysics9RecordDocumentEquality implements Equality<Qphysics9Record> {
  const Qphysics9RecordDocumentEquality();

  @override
  bool equals(Qphysics9Record? e1, Qphysics9Record? e2) {
  ...
  @override
  int hash(Qphysics9Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qphysics9Record;
}
