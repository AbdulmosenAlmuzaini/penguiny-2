...
class Qmath10Record extends FirestoreRecord {
  Qmath10Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qmath10');

  static Stream<Qmath10Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qmath10Record.fromSnapshot(s));

  static Future<Qmath10Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qmath10Record.fromSnapshot(s));

  static Qmath10Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qmath10Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qmath10Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qmath10Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qmath10Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qmath10Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQmath10RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qmath10RecordDocumentEquality implements Equality<Qmath10Record> {
  const Qmath10RecordDocumentEquality();

  @override
  bool equals(Qmath10Record? e1, Qmath10Record? e2) {
  ...
  @override
  int hash(Qmath10Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qmath10Record;
}
