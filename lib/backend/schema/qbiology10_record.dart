...
class Qbiology10Record extends FirestoreRecord {
  Qbiology10Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qbiology10');

  static Stream<Qbiology10Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qbiology10Record.fromSnapshot(s));

  static Future<Qbiology10Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qbiology10Record.fromSnapshot(s));

  static Qbiology10Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qbiology10Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qbiology10Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qbiology10Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qbiology10Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qbiology10Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQbiology10RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qbiology10RecordDocumentEquality implements Equality<Qbiology10Record> {
  const Qbiology10RecordDocumentEquality();

  @override
  bool equals(Qbiology10Record? e1, Qbiology10Record? e2) {
  ...
  @override
  int hash(Qbiology10Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qbiology10Record;
}
