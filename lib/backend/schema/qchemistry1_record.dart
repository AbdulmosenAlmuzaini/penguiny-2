...
class Qchemistry1Record extends FirestoreRecord {
  Qchemistry1Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qchemistry1');

  static Stream<Qchemistry1Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qchemistry1Record.fromSnapshot(s));

  static Future<Qchemistry1Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qchemistry1Record.fromSnapshot(s));

  static Qchemistry1Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qchemistry1Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qchemistry1Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qchemistry1Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qchemistry1Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qchemistry1Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQchemistry1RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qchemistry1RecordDocumentEquality implements Equality<Qchemistry1Record> {
  const Qchemistry1RecordDocumentEquality();

  @override
  bool equals(Qchemistry1Record? e1, Qchemistry1Record? e2) {
  ...
  @override
  int hash(Qchemistry1Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qchemistry1Record;
}
