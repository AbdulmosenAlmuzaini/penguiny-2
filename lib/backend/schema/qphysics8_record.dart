...
class Qphysics8Record extends FirestoreRecord {
  Qphysics8Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qphysics8');

  static Stream<Qphysics8Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qphysics8Record.fromSnapshot(s));

  static Future<Qphysics8Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qphysics8Record.fromSnapshot(s));

  static Qphysics8Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qphysics8Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qphysics8Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qphysics8Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qphysics8Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qphysics8Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQphysics8RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qphysics8RecordDocumentEquality implements Equality<Qphysics8Record> {
  const Qphysics8RecordDocumentEquality();

  @override
  bool equals(Qphysics8Record? e1, Qphysics8Record? e2) {
  ...
  @override
  int hash(Qphysics8Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qphysics8Record;
}
