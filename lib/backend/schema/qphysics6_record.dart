...
class Qphysics6Record extends FirestoreRecord {
  Qphysics6Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qphysics6');

  static Stream<Qphysics6Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qphysics6Record.fromSnapshot(s));

  static Future<Qphysics6Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qphysics6Record.fromSnapshot(s));

  static Qphysics6Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qphysics6Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qphysics6Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qphysics6Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qphysics6Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qphysics6Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQphysics6RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qphysics6RecordDocumentEquality implements Equality<Qphysics6Record> {
  const Qphysics6RecordDocumentEquality();

  @override
  bool equals(Qphysics6Record? e1, Qphysics6Record? e2) {
  ...
  @override
  int hash(Qphysics6Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qphysics6Record;
}
