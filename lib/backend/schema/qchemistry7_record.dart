...
class Qchemistry7Record extends FirestoreRecord {
  Qchemistry7Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qchemistry7');

  static Stream<Qchemistry7Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qchemistry7Record.fromSnapshot(s));

  static Future<Qchemistry7Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qchemistry7Record.fromSnapshot(s));

  static Qchemistry7Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qchemistry7Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qchemistry7Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qchemistry7Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qchemistry7Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qchemistry7Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQchemistry7RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qchemistry7RecordDocumentEquality implements Equality<Qchemistry7Record> {
  const Qchemistry7RecordDocumentEquality();

  @override
  bool equals(Qchemistry7Record? e1, Qchemistry7Record? e2) {
  ...
  @override
  int hash(Qchemistry7Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qchemistry7Record;
}
