...
class Qmath8Record extends FirestoreRecord {
  Qmath8Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qmath8');

  static Stream<Qmath8Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qmath8Record.fromSnapshot(s));

  static Future<Qmath8Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qmath8Record.fromSnapshot(s));

  static Qmath8Record fromSnapshot(DocumentSnapshot snapshot) => Qmath8Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qmath8Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qmath8Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qmath8Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qmath8Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQmath8RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qmath8RecordDocumentEquality implements Equality<Qmath8Record> {
  const Qmath8RecordDocumentEquality();

  @override
  bool equals(Qmath8Record? e1, Qmath8Record? e2) {
  ...
  @override
  int hash(Qmath8Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qmath8Record;
}
