...
class Qchemistry9Record extends FirestoreRecord {
  Qchemistry9Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qchemistry9');

  static Stream<Qchemistry9Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qchemistry9Record.fromSnapshot(s));

  static Future<Qchemistry9Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qchemistry9Record.fromSnapshot(s));

  static Qchemistry9Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qchemistry9Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qchemistry9Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qchemistry9Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qchemistry9Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qchemistry9Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQchemistry9RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qchemistry9RecordDocumentEquality implements Equality<Qchemistry9Record> {
  const Qchemistry9RecordDocumentEquality();

  @override
  bool equals(Qchemistry9Record? e1, Qchemistry9Record? e2) {
  ...
  @override
  int hash(Qchemistry9Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qchemistry9Record;
}
