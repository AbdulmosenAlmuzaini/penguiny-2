...
class Qmath7Record extends FirestoreRecord {
  Qmath7Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qmath7');

  static Stream<Qmath7Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qmath7Record.fromSnapshot(s));

  static Future<Qmath7Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qmath7Record.fromSnapshot(s));

  static Qmath7Record fromSnapshot(DocumentSnapshot snapshot) => Qmath7Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qmath7Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qmath7Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qmath7Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qmath7Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQmath7RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qmath7RecordDocumentEquality implements Equality<Qmath7Record> {
  const Qmath7RecordDocumentEquality();

  @override
  bool equals(Qmath7Record? e1, Qmath7Record? e2) {
  ...
  @override
  int hash(Qmath7Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qmath7Record;
}
