...
class Qmath15Record extends FirestoreRecord {
  Qmath15Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qmath15');

  static Stream<Qmath15Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qmath15Record.fromSnapshot(s));

  static Future<Qmath15Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qmath15Record.fromSnapshot(s));

  static Qmath15Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qmath15Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qmath15Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qmath15Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qmath15Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qmath15Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQmath15RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qmath15RecordDocumentEquality implements Equality<Qmath15Record> {
  const Qmath15RecordDocumentEquality();

  @override
  bool equals(Qmath15Record? e1, Qmath15Record? e2) {
  ...
  @override
  int hash(Qmath15Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qmath15Record;
}
