...
class Qbiology6Record extends FirestoreRecord {
  Qbiology6Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qbiology6');

  static Stream<Qbiology6Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qbiology6Record.fromSnapshot(s));

  static Future<Qbiology6Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qbiology6Record.fromSnapshot(s));

  static Qbiology6Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qbiology6Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qbiology6Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qbiology6Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qbiology6Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qbiology6Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQbiology6RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qbiology6RecordDocumentEquality implements Equality<Qbiology6Record> {
  const Qbiology6RecordDocumentEquality();

  @override
  bool equals(Qbiology6Record? e1, Qbiology6Record? e2) {
  ...
  @override
  int hash(Qbiology6Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qbiology6Record;
}
