...
class Qmath12Record extends FirestoreRecord {
  Qmath12Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qmath12');

  static Stream<Qmath12Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qmath12Record.fromSnapshot(s));

  static Future<Qmath12Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qmath12Record.fromSnapshot(s));

  static Qmath12Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qmath12Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qmath12Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qmath12Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qmath12Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qmath12Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQmath12RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qmath12RecordDocumentEquality implements Equality<Qmath12Record> {
  const Qmath12RecordDocumentEquality();

  @override
  bool equals(Qmath12Record? e1, Qmath12Record? e2) {
  ...
  @override
  int hash(Qmath12Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qmath12Record;
}
