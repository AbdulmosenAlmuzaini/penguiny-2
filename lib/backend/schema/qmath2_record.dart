...
class Qmath2Record extends FirestoreRecord {
  Qmath2Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qmath2');

  static Stream<Qmath2Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qmath2Record.fromSnapshot(s));

  static Future<Qmath2Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qmath2Record.fromSnapshot(s));

  static Qmath2Record fromSnapshot(DocumentSnapshot snapshot) => Qmath2Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qmath2Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qmath2Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qmath2Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qmath2Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQmath2RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qmath2RecordDocumentEquality implements Equality<Qmath2Record> {
  const Qmath2RecordDocumentEquality();

  @override
  bool equals(Qmath2Record? e1, Qmath2Record? e2) {
  ...
  @override
  int hash(Qmath2Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qmath2Record;
}
