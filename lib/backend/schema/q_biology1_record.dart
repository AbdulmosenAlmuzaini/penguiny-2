...
class QBiology1Record extends FirestoreRecord {
  QBiology1Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('QBiology1');

  static Stream<QBiology1Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => QBiology1Record.fromSnapshot(s));

  static Future<QBiology1Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => QBiology1Record.fromSnapshot(s));

  static QBiology1Record fromSnapshot(DocumentSnapshot snapshot) =>
      QBiology1Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static QBiology1Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      QBiology1Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'QBiology1Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is QBiology1Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQBiology1RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class QBiology1RecordDocumentEquality implements Equality<QBiology1Record> {
  const QBiology1RecordDocumentEquality();

  @override
  bool equals(QBiology1Record? e1, QBiology1Record? e2) {
  ...
  @override
  int hash(QBiology1Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is QBiology1Record;
}
