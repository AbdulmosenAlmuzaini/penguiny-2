...
class Qmath9Record extends FirestoreRecord {
  Qmath9Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qmath9');

  static Stream<Qmath9Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qmath9Record.fromSnapshot(s));

  static Future<Qmath9Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qmath9Record.fromSnapshot(s));

  static Qmath9Record fromSnapshot(DocumentSnapshot snapshot) => Qmath9Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qmath9Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qmath9Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qmath9Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qmath9Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQmath9RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qmath9RecordDocumentEquality implements Equality<Qmath9Record> {
  const Qmath9RecordDocumentEquality();

  @override
  bool equals(Qmath9Record? e1, Qmath9Record? e2) {
  ...
  @override
  int hash(Qmath9Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qmath9Record;
}
