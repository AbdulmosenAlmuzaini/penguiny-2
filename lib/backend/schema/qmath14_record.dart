...
class Qmath14Record extends FirestoreRecord {
  Qmath14Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qmath14');

  static Stream<Qmath14Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qmath14Record.fromSnapshot(s));

  static Future<Qmath14Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qmath14Record.fromSnapshot(s));

  static Qmath14Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qmath14Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qmath14Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qmath14Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qmath14Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qmath14Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQmath14RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qmath14RecordDocumentEquality implements Equality<Qmath14Record> {
  const Qmath14RecordDocumentEquality();

  @override
  bool equals(Qmath14Record? e1, Qmath14Record? e2) {
  ...
  @override
  int hash(Qmath14Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qmath14Record;
}
