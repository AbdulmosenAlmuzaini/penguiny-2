...
class Qphysics7Record extends FirestoreRecord {
  Qphysics7Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qphysics7');

  static Stream<Qphysics7Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qphysics7Record.fromSnapshot(s));

  static Future<Qphysics7Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qphysics7Record.fromSnapshot(s));

  static Qphysics7Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qphysics7Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qphysics7Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qphysics7Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qphysics7Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qphysics7Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQphysics7RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qphysics7RecordDocumentEquality implements Equality<Qphysics7Record> {
  const Qphysics7RecordDocumentEquality();

  @override
  bool equals(Qphysics7Record? e1, Qphysics7Record? e2) {
  ...
  @override
  int hash(Qphysics7Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qphysics7Record;
}
