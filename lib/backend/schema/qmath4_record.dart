...
class Qmath4Record extends FirestoreRecord {
  Qmath4Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qmath4');

  static Stream<Qmath4Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qmath4Record.fromSnapshot(s));

  static Future<Qmath4Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qmath4Record.fromSnapshot(s));

  static Qmath4Record fromSnapshot(DocumentSnapshot snapshot) => Qmath4Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qmath4Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qmath4Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qmath4Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qmath4Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQmath4RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qmath4RecordDocumentEquality implements Equality<Qmath4Record> {
  const Qmath4RecordDocumentEquality();

  @override
  bool equals(Qmath4Record? e1, Qmath4Record? e2) {
  ...
  @override
  int hash(Qmath4Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qmath4Record;
}
