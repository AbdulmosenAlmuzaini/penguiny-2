...
class Qchemistry11Record extends FirestoreRecord {
  Qchemistry11Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qchemistry11');

  static Stream<Qchemistry11Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qchemistry11Record.fromSnapshot(s));

  static Future<Qchemistry11Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qchemistry11Record.fromSnapshot(s));

  static Qchemistry11Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qchemistry11Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qchemistry11Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qchemistry11Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qchemistry11Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qchemistry11Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQchemistry11RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qchemistry11RecordDocumentEquality
    implements Equality<Qchemistry11Record> {
  const Qchemistry11RecordDocumentEquality();

  @override
  bool equals(Qchemistry11Record? e1, Qchemistry11Record? e2) {
  ...
  @override
  int hash(Qchemistry11Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qchemistry11Record;
}
