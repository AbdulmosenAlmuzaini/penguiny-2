...
class Qmath6Record extends FirestoreRecord {
  Qmath6Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qmath6');

  static Stream<Qmath6Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qmath6Record.fromSnapshot(s));

  static Future<Qmath6Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qmath6Record.fromSnapshot(s));

  static Qmath6Record fromSnapshot(DocumentSnapshot snapshot) => Qmath6Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qmath6Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qmath6Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qmath6Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qmath6Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQmath6RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qmath6RecordDocumentEquality implements Equality<Qmath6Record> {
  const Qmath6RecordDocumentEquality();

  @override
  bool equals(Qmath6Record? e1, Qmath6Record? e2) {
  ...
  @override
  int hash(Qmath6Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qmath6Record;
}
