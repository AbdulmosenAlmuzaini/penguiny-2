...
class Qphysics3Record extends FirestoreRecord {
  Qphysics3Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qphysics3');

  static Stream<Qphysics3Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qphysics3Record.fromSnapshot(s));

  static Future<Qphysics3Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qphysics3Record.fromSnapshot(s));

  static Qphysics3Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qphysics3Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qphysics3Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qphysics3Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qphysics3Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qphysics3Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQphysics3RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qphysics3RecordDocumentEquality implements Equality<Qphysics3Record> {
  const Qphysics3RecordDocumentEquality();

  @override
  bool equals(Qphysics3Record? e1, Qphysics3Record? e2) {
  ...
  @override
  int hash(Qphysics3Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qphysics3Record;
}
