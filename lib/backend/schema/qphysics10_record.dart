...
class Qphysics10Record extends FirestoreRecord {
  Qphysics10Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qphysics10');

  static Stream<Qphysics10Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qphysics10Record.fromSnapshot(s));

  static Future<Qphysics10Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qphysics10Record.fromSnapshot(s));

  static Qphysics10Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qphysics10Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qphysics10Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qphysics10Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qphysics10Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qphysics10Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQphysics10RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qphysics10RecordDocumentEquality implements Equality<Qphysics10Record> {
  const Qphysics10RecordDocumentEquality();

  @override
  bool equals(Qphysics10Record? e1, Qphysics10Record? e2) {
  ...
  @override
  int hash(Qphysics10Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qphysics10Record;
}
