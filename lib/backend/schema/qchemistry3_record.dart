...
class Qchemistry3Record extends FirestoreRecord {
  Qchemistry3Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qchemistry3');

  static Stream<Qchemistry3Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qchemistry3Record.fromSnapshot(s));

  static Future<Qchemistry3Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qchemistry3Record.fromSnapshot(s));

  static Qchemistry3Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qchemistry3Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qchemistry3Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qchemistry3Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qchemistry3Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qchemistry3Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQchemistry3RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qchemistry3RecordDocumentEquality implements Equality<Qchemistry3Record> {
  const Qchemistry3RecordDocumentEquality();

  @override
  bool equals(Qchemistry3Record? e1, Qchemistry3Record? e2) {
  ...
  @override
  int hash(Qchemistry3Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qchemistry3Record;
}
