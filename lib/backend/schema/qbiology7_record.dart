...
class Qbiology7Record extends FirestoreRecord {
  Qbiology7Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qbiology7');

  static Stream<Qbiology7Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qbiology7Record.fromSnapshot(s));

  static Future<Qbiology7Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qbiology7Record.fromSnapshot(s));

  static Qbiology7Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qbiology7Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qbiology7Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qbiology7Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qbiology7Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qbiology7Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQbiology7RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qbiology7RecordDocumentEquality implements Equality<Qbiology7Record> {
  const Qbiology7RecordDocumentEquality();

  @override
  bool equals(Qbiology7Record? e1, Qbiology7Record? e2) {
  ...
  @override
  int hash(Qbiology7Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qbiology7Record;
}
