...
class Qmath13Record extends FirestoreRecord {
  Qmath13Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qmath13');

  static Stream<Qmath13Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qmath13Record.fromSnapshot(s));

  static Future<Qmath13Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qmath13Record.fromSnapshot(s));

  static Qmath13Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qmath13Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qmath13Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qmath13Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qmath13Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qmath13Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQmath13RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qmath13RecordDocumentEquality implements Equality<Qmath13Record> {
  const Qmath13RecordDocumentEquality();

  @override
  bool equals(Qmath13Record? e1, Qmath13Record? e2) {
  ...
  @override
  int hash(Qmath13Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qmath13Record;
}
