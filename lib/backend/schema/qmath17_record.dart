...
class Qmath17Record extends FirestoreRecord {
  Qmath17Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qmath17');

  static Stream<Qmath17Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qmath17Record.fromSnapshot(s));

  static Future<Qmath17Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qmath17Record.fromSnapshot(s));

  static Qmath17Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qmath17Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qmath17Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qmath17Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qmath17Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qmath17Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQmath17RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qmath17RecordDocumentEquality implements Equality<Qmath17Record> {
  const Qmath17RecordDocumentEquality();

  @override
  bool equals(Qmath17Record? e1, Qmath17Record? e2) {
  ...
  @override
  int hash(Qmath17Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qmath17Record;
}
