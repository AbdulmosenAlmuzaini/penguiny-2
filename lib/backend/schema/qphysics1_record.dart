...
class Qphysics1Record extends FirestoreRecord {
  Qphysics1Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qphysics1');

  static Stream<Qphysics1Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qphysics1Record.fromSnapshot(s));

  static Future<Qphysics1Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qphysics1Record.fromSnapshot(s));

  static Qphysics1Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qphysics1Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qphysics1Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qphysics1Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qphysics1Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qphysics1Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQphysics1RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qphysics1RecordDocumentEquality implements Equality<Qphysics1Record> {
  const Qphysics1RecordDocumentEquality();

  @override
  bool equals(Qphysics1Record? e1, Qphysics1Record? e2) {
  ...
  @override
  int hash(Qphysics1Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qphysics1Record;
}
