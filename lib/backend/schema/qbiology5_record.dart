...
class Qbiology5Record extends FirestoreRecord {
  Qbiology5Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qbiology5');

  static Stream<Qbiology5Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qbiology5Record.fromSnapshot(s));

  static Future<Qbiology5Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qbiology5Record.fromSnapshot(s));

  static Qbiology5Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qbiology5Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qbiology5Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qbiology5Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qbiology5Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qbiology5Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQbiology5RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qbiology5RecordDocumentEquality implements Equality<Qbiology5Record> {
  const Qbiology5RecordDocumentEquality();

  @override
  bool equals(Qbiology5Record? e1, Qbiology5Record? e2) {
  ...
  @override
  int hash(Qbiology5Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qbiology5Record;
}
