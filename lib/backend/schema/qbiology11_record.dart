...
class Qbiology11Record extends FirestoreRecord {
  Qbiology11Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qbiology11');

  static Stream<Qbiology11Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qbiology11Record.fromSnapshot(s));

  static Future<Qbiology11Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qbiology11Record.fromSnapshot(s));

  static Qbiology11Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qbiology11Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qbiology11Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qbiology11Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qbiology11Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qbiology11Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQbiology11RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qbiology11RecordDocumentEquality implements Equality<Qbiology11Record> {
  const Qbiology11RecordDocumentEquality();

  @override
  bool equals(Qbiology11Record? e1, Qbiology11Record? e2) {
  ...
  @override
  int hash(Qbiology11Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qbiology11Record;
}
