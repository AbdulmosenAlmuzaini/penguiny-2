...
class Qphysics4Record extends FirestoreRecord {
  Qphysics4Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qphysics4');

  static Stream<Qphysics4Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qphysics4Record.fromSnapshot(s));

  static Future<Qphysics4Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qphysics4Record.fromSnapshot(s));

  static Qphysics4Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qphysics4Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qphysics4Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qphysics4Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qphysics4Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qphysics4Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQphysics4RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qphysics4RecordDocumentEquality implements Equality<Qphysics4Record> {
  const Qphysics4RecordDocumentEquality();

  @override
  bool equals(Qphysics4Record? e1, Qphysics4Record? e2) {
  ...
  @override
  int hash(Qphysics4Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qphysics4Record;
}
