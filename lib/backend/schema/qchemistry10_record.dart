...
class Qchemistry10Record extends FirestoreRecord {
  Qchemistry10Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qchemistry10');

  static Stream<Qchemistry10Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qchemistry10Record.fromSnapshot(s));

  static Future<Qchemistry10Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qchemistry10Record.fromSnapshot(s));

  static Qchemistry10Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qchemistry10Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qchemistry10Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qchemistry10Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qchemistry10Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qchemistry10Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQchemistry10RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qchemistry10RecordDocumentEquality
    implements Equality<Qchemistry10Record> {
  const Qchemistry10RecordDocumentEquality();

  @override
  bool equals(Qchemistry10Record? e1, Qchemistry10Record? e2) {
  ...
  @override
  int hash(Qchemistry10Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qchemistry10Record;
}
