...
class Qbiology9Record extends FirestoreRecord {
  Qbiology9Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qbiology9');

  static Stream<Qbiology9Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qbiology9Record.fromSnapshot(s));

  static Future<Qbiology9Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qbiology9Record.fromSnapshot(s));

  static Qbiology9Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qbiology9Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qbiology9Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qbiology9Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qbiology9Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qbiology9Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQbiology9RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qbiology9RecordDocumentEquality implements Equality<Qbiology9Record> {
  const Qbiology9RecordDocumentEquality();

  @override
  bool equals(Qbiology9Record? e1, Qbiology9Record? e2) {
  ...
  @override
  int hash(Qbiology9Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qbiology9Record;
}
