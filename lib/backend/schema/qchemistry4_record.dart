...
class Qchemistry4Record extends FirestoreRecord {
  Qchemistry4Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qchemistry4');

  static Stream<Qchemistry4Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qchemistry4Record.fromSnapshot(s));

  static Future<Qchemistry4Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qchemistry4Record.fromSnapshot(s));

  static Qchemistry4Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qchemistry4Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qchemistry4Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qchemistry4Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qchemistry4Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qchemistry4Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQchemistry4RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qchemistry4RecordDocumentEquality implements Equality<Qchemistry4Record> {
  const Qchemistry4RecordDocumentEquality();

  @override
  bool equals(Qchemistry4Record? e1, Qchemistry4Record? e2) {
  ...
  @override
  int hash(Qchemistry4Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qchemistry4Record;
}
