...
class Qphysics5Record extends FirestoreRecord {
  Qphysics5Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qphysics5');

  static Stream<Qphysics5Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qphysics5Record.fromSnapshot(s));

  static Future<Qphysics5Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qphysics5Record.fromSnapshot(s));

  static Qphysics5Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qphysics5Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qphysics5Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qphysics5Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qphysics5Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qphysics5Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQphysics5RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qphysics5RecordDocumentEquality implements Equality<Qphysics5Record> {
  const Qphysics5RecordDocumentEquality();

  @override
  bool equals(Qphysics5Record? e1, Qphysics5Record? e2) {
  ...
  @override
  int hash(Qphysics5Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qphysics5Record;
}
