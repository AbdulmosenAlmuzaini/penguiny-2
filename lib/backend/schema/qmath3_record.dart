...
class Qmath3Record extends FirestoreRecord {
  Qmath3Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qmath3');

  static Stream<Qmath3Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qmath3Record.fromSnapshot(s));

  static Future<Qmath3Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qmath3Record.fromSnapshot(s));

  static Qmath3Record fromSnapshot(DocumentSnapshot snapshot) => Qmath3Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qmath3Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qmath3Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qmath3Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qmath3Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQmath3RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qmath3RecordDocumentEquality implements Equality<Qmath3Record> {
  const Qmath3RecordDocumentEquality();

  @override
  bool equals(Qmath3Record? e1, Qmath3Record? e2) {
  ...
  @override
  int hash(Qmath3Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qmath3Record;
}
