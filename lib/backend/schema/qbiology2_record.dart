...
class Qbiology2Record extends FirestoreRecord {
  Qbiology2Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qbiology2');

  static Stream<Qbiology2Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qbiology2Record.fromSnapshot(s));

  static Future<Qbiology2Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qbiology2Record.fromSnapshot(s));

  static Qbiology2Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qbiology2Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qbiology2Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qbiology2Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qbiology2Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qbiology2Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQbiology2RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qbiology2RecordDocumentEquality implements Equality<Qbiology2Record> {
  const Qbiology2RecordDocumentEquality();

  @override
  bool equals(Qbiology2Record? e1, Qbiology2Record? e2) {
  ...
  @override
  int hash(Qbiology2Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qbiology2Record;
}
