...
class Qmath1Record extends FirestoreRecord {
  Qmath1Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qmath1');

  static Stream<Qmath1Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qmath1Record.fromSnapshot(s));

  static Future<Qmath1Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qmath1Record.fromSnapshot(s));

  static Qmath1Record fromSnapshot(DocumentSnapshot snapshot) => Qmath1Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qmath1Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qmath1Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qmath1Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qmath1Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQmath1RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qmath1RecordDocumentEquality implements Equality<Qmath1Record> {
  const Qmath1RecordDocumentEquality();

  @override
  bool equals(Qmath1Record? e1, Qmath1Record? e2) {
  ...
  @override
  int hash(Qmath1Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qmath1Record;
}
