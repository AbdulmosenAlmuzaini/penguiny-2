...
class Qmath11Record extends FirestoreRecord {
  Qmath11Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qmath11');

  static Stream<Qmath11Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qmath11Record.fromSnapshot(s));

  static Future<Qmath11Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qmath11Record.fromSnapshot(s));

  static Qmath11Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qmath11Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qmath11Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qmath11Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qmath11Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qmath11Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQmath11RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qmath11RecordDocumentEquality implements Equality<Qmath11Record> {
  const Qmath11RecordDocumentEquality();

  @override
  bool equals(Qmath11Record? e1, Qmath11Record? e2) {
  ...
  @override
  int hash(Qmath11Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qmath11Record;
}
