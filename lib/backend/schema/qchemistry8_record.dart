...
class Qchemistry8Record extends FirestoreRecord {
  Qchemistry8Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qchemistry8');

  static Stream<Qchemistry8Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qchemistry8Record.fromSnapshot(s));

  static Future<Qchemistry8Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qchemistry8Record.fromSnapshot(s));

  static Qchemistry8Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qchemistry8Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qchemistry8Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qchemistry8Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qchemistry8Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qchemistry8Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQchemistry8RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qchemistry8RecordDocumentEquality implements Equality<Qchemistry8Record> {
  const Qchemistry8RecordDocumentEquality();

  @override
  bool equals(Qchemistry8Record? e1, Qchemistry8Record? e2) {
  ...
  @override
  int hash(Qchemistry8Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qchemistry8Record;
}
