...
class Qchemistry6Record extends FirestoreRecord {
  Qchemistry6Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qchemistry6');

  static Stream<Qchemistry6Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qchemistry6Record.fromSnapshot(s));

  static Future<Qchemistry6Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qchemistry6Record.fromSnapshot(s));

  static Qchemistry6Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qchemistry6Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qchemistry6Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qchemistry6Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qchemistry6Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qchemistry6Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQchemistry6RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qchemistry6RecordDocumentEquality implements Equality<Qchemistry6Record> {
  const Qchemistry6RecordDocumentEquality();

  @override
  bool equals(Qchemistry6Record? e1, Qchemistry6Record? e2) {
  ...
  @override
  int hash(Qchemistry6Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qchemistry6Record;
}
