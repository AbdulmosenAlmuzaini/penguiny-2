...
class Qmath5Record extends FirestoreRecord {
  Qmath5Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qmath5');

  static Stream<Qmath5Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qmath5Record.fromSnapshot(s));

  static Future<Qmath5Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qmath5Record.fromSnapshot(s));

  static Qmath5Record fromSnapshot(DocumentSnapshot snapshot) => Qmath5Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qmath5Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qmath5Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qmath5Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qmath5Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQmath5RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qmath5RecordDocumentEquality implements Equality<Qmath5Record> {
  const Qmath5RecordDocumentEquality();

  @override
  bool equals(Qmath5Record? e1, Qmath5Record? e2) {
  ...
  @override
  int hash(Qmath5Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qmath5Record;
}
