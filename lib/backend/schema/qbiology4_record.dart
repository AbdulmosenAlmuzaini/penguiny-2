...
class Qbiology4Record extends FirestoreRecord {
  Qbiology4Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qbiology4');

  static Stream<Qbiology4Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qbiology4Record.fromSnapshot(s));

  static Future<Qbiology4Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qbiology4Record.fromSnapshot(s));

  static Qbiology4Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qbiology4Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qbiology4Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qbiology4Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qbiology4Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qbiology4Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQbiology4RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qbiology4RecordDocumentEquality implements Equality<Qbiology4Record> {
  const Qbiology4RecordDocumentEquality();

  @override
  bool equals(Qbiology4Record? e1, Qbiology4Record? e2) {
  ...
  @override
  int hash(Qbiology4Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qbiology4Record;
}
