...
class Qbiology8Record extends FirestoreRecord {
  Qbiology8Record._(
  ...
  static CollectionReference get collection =>
      FirebaseFirestore.instance.collection('Qbiology8');

  static Stream<Qbiology8Record> getDocument(DocumentReference ref) =>
      ref.snapshots().map((s) => Qbiology8Record.fromSnapshot(s));

  static Future<Qbiology8Record> getDocumentOnce(DocumentReference ref) =>
      ref.get().then((s) => Qbiology8Record.fromSnapshot(s));

  static Qbiology8Record fromSnapshot(DocumentSnapshot snapshot) =>
      Qbiology8Record._(
        snapshot.reference,
        mapFromFirestore(snapshot.data() as Map<String, dynamic>),
      );

  static Qbiology8Record getDocumentFromData(
    Map<String, dynamic> data,
    DocumentReference reference,
  ) =>
      Qbiology8Record._(reference, mapFromFirestore(data));

  @override
  String toString() =>
      'Qbiology8Record(reference: ${reference.path}, data: $snapshotData)';
  ...
  @override
  bool operator ==(other) =>
      other is Qbiology8Record &&
      reference.path.hashCode == other.reference.path.hashCode;
}

Map<String, dynamic> createQbiology8RecordData({
  int? qNumber,
  String? qType,
  String? qText,
  String? qImg,
...
class Qbiology8RecordDocumentEquality implements Equality<Qbiology8Record> {
  const Qbiology8RecordDocumentEquality();

  @override
  bool equals(Qbiology8Record? e1, Qbiology8Record? e2) {
  ...
  @override
  int hash(Qbiology8Record? e) => const ListEquality().hash([
        e?.qNumber,
        e?.qType,
        e?.qText,
        e?.qImg,
  ...
  @override
  bool isValidKey(Object? o) => o is Qbiology8Record;
}
